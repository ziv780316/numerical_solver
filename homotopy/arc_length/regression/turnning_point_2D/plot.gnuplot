...
plot 'run.log.trace' using ($1):($2) title 'x1' with linespoints linestyle 2 pointtype 7 pointsize 2, \
'run.log.trace' using ($1):($3) title 'x2' with linespoints linestyle 3 pointtype 7 pointsize 2
