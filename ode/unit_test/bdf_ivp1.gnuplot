...
set output 'bdf_ivp1.png'

f(x)=exp(-x)

plot f(x) title 'e^-t' with lines linestyle 1,\
'output_ivp1_bdf1_t0p1' using ($1):($2) title 'BDF1_0p1' with lines linestyle 2,\
'output_ivp1_bdf2_t0p1' using ($1):($2) title 'BDF2_0p1' with lines linestyle 3,\
'output_ivp1_bdf3_t0p1' using ($1):($2) title 'BDF3_0p1' with lines linestyle 4
