...
'output_ab1_t1p9' using ($1):($2) title 'AB1_1p9' with lines linestyle 2,\
'output_ab1_t2p1' using ($1):($2) title 'AB1_2p1' with lines linestyle 3,\
'output_ab3_t0p5' using ($1):($2) title 'AB3_0p5' with lines linestyle 4,\
'output_ab3_t0p6' using ($1):($2) title 'AB3_0p6' with lines linestyle 5
